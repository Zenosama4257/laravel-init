                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.clients.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_name" id="contact_name" class="form-control {{$errors->has('contact_name') ? 'is-invalid' : ''}}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="contact_email" id="contact_email" class="form-control {{$errors->has('contact_email') ? 'is-invalid' : ''}}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_phone_number" id="contact_phone_number" class="form-control {{$errors->has('contact_phone_number') ? 'is-invalid' : ''}}"
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Ingrese la dirección de la empresa" value="{{old('company_address', '')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="company_phone_number" id="company_phone_number" class="form-control {{$errors->has('company_phone_number') ? 'is-invalid' : ''}}"
